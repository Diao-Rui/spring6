...
public class LogAspect {
     ...
     */
    //前置通知
    @Before(value = "execution(public int aop.service.CalculatorImpl.*(..))")
    ...
    //后置通知
    @After(value = "execution(* aop.service.CalculatorImpl.*(..))")
    ...
    //返回通知
    @AfterReturning(value = "execution(* aop.service.CalculatorImpl.*(..))", returning = "result")
    ...
    //异常通知
    @AfterThrowing(value = "execution(* aop.service.CalculatorImpl.*(..))", throwing = "throwable")
    ...
    //环绕通知
    @Around(value = "execution(* aop.service.CalculatorImpl.*(..))")
